    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numArrays; i++) {
            ...
            for (int j = 0; j < arraySize; j++) {
                ...
                // Note the arrays can have duplicates.
                randomArray[j] = random.nextInt();
            }
            // all the arrays are sorted before being fed to the algorithm.
            // here it doesn't matter whether we use selection sort or merge sort.
